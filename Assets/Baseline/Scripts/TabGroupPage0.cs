...
public class TabGroupPage0 : MonoBehaviour
{
    ...
    public List<TabButtonPage0> tabButtons;

   // public Sprite tabIdle, tabHover, tabActive;
    
    public TabButtonPage0 selectedTab;
    ...
    public void Suscribe (TabButtonPage0 button){
        if (tabButtons == null){
            tabButtons = new List<TabButtonPage0>();
        }

        tabButtons.Add(button);
    }

    public void OnTabEnter(TabButtonPage0 button){
        ResetTabs();
    ...
    public void OnTabExit(TabButtonPage0 button){
        ResetTabs();
    ...
    public void OnTabSelected(TabButtonPage0 button){
        if (selectedTab != null && button == selectedTab){
            selectedTab = null;
            ResetPages();
            button.GetComponent<Image>().color = hoverColor;
    ...
    public void ResetTabs(){
        foreach(TabButtonPage0 button in tabButtons){
