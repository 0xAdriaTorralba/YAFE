...
public class TabGroupMain : MonoBehaviour
{
    ...
    public List<TabButtonMain> tabButtons;

   // public Sprite tabIdle, tabHover, tabActive;
    
    public TabButtonMain selectedTab;
    ...
    public void OnTabEnter(TabButtonMain button){
        ResetTabs();
    ...
    public void OnTabExit(TabButtonMain button){
        ResetTabs();
    ...
    public void OnTabSelected(TabButtonMain button){
        if (selectedTab != null && button == selectedTab){
            selectedTab = null;
            ResetPages();
            button.GetComponent<Image>().color = hoverColor;
    ...
    public void ResetTabs(){
        foreach(TabButtonMain button in tabButtons){
